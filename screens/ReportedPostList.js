...
class ReportedPostList extends React.Component {
  constructor(props) {
    super(props);
    this.cellRefs = {};
    this.sheetRef = {};
                  ...
                  >
                    ...
                    {this.props.user.isSuperAdmin && (
                      ...
                      >
                        ...
                        />
                        <Text
                          style={[styles.bold, styles.red, { fontSize: 20 }]}
                        >
...
export default connect(mapStateToProps, mapDispatchToProps)(ReportedPostList);
